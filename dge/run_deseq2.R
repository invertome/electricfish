...
contrasts <- list(
  ...
  c("condition", "SM_saline_adlib", "EO_saline_adlib"),
  c("condition", "SM_leptin_adlib", "EO_leptin_adlib"),
  c("condition", "SM_saline_adlib", "SM_leptin_adlib"),
  c("condition", "SM_saline_fooddep", "SM_leptin_fooddep"),
...
names(res_list) <- c(
  ...
  "SM_saline_adlib_vs_EO_saline_adlib",
  "SM_leptin_adlib_vs_EO_leptin_adlib",
